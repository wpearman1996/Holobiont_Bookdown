...
microbiome_importances<-rep(0,Host_PopSize)#runif(Host_PopSize,0,1)
...
sec_varyring_envs_multigen<-readr::read_rds(paste0("rerun_1nov_rerun_sec_varyring_envs_multigen","_replicate_",rep_number,".RDS"))

sec_varyring_envs_multigen<-sec_varyring_envs_multigen[grepl("1gen|2gen|200gen",names(sec_varyring_envs_multigen))]
...
write_rds(x=results_multigen_unlist,file = paste0("tm_1_2Nov_results_multigen_replicate_",rep_number,".RDS"),compress = "gz" )
